...
public class Soldier implements Runnable{
	...
	public Soldier(GameCube gameCube,int index, PlayerResources pr){
	...
	public void decreaseHealth(int damagePoint) {
		...
		PR.getClient().sendMap(gameCube.ClientNumber-1,index,3,gameCube.cube[gameCube.ClientNumber-1][index][2],   -1,0,0);
	}
	...
	public void setY(int y) {
		...
		PR.getClient().sendMap(gameCube.ClientNumber-1,index,3,y,   -1,0,0);
	}
